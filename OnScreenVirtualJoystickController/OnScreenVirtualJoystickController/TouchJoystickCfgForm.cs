...
{
    public partial class TouchJoystickCfgForm : Form
    {
        public TouchControllerForm mController;
        ...
        public TouchJoystickCfgForm(TouchControllerForm controller)
        {
            InitializeComponent();
            ...
            mTopLeft = new RectangleF(30, 30, 5, 5);
            mTopCenter = new RectangleF(67, 30, 5, 5);
            mTopRight = new RectangleF(104, 30, 5, 5);

            mMiddleLeft = new RectangleF(30, 67, 5, 5);
            mMiddleCenter = new RectangleF(67, 67, 5, 5);
            mMiddleRight = new RectangleF(104, 67, 5, 5);

            mBottomLeft = new RectangleF(30, 104, 5, 5);
            mBottomCenter = new RectangleF(67, 104, 5, 5);
            mBottomRight = new RectangleF(104, 104, 5, 5);

            mGestureRectList.Add(new RectangleF(27, 27, 11, 11));
            mGestureRectList.Add(new RectangleF(65, 27, 11, 11));
            mGestureRectList.Add(new RectangleF(102, 27, 11, 11));

            mGestureRectList.Add(new RectangleF(27, 65, 11, 11));
            mGestureRectList.Add(new RectangleF(65, 65, 11, 11));
            mGestureRectList.Add(new RectangleF(102, 65, 11, 11));

            mGestureRectList.Add(new RectangleF(27, 102, 11, 11));
            mGestureRectList.Add(new RectangleF(65, 102, 11, 11));
            mGestureRectList.Add(new RectangleF(102, 102, 11, 11));
            ...
            mTrackPen.StartCap = System.Drawing.Drawing2D.LineCap.Round;
            mTrackPen.EndCap = System.Drawing.Drawing2D.LineCap.Round;
        }

        public bool loadConfigFromFile()
        {
            if (!File.Exists("touch.list"))
            {
            ...
            StreamReader _readfile = new StreamReader("touch.list");
        ...
        {
            StreamWriter _file = new StreamWriter("touch.list");
        ...
        private void DangerButton_MouseClick(object sender, MouseEventArgs e)
        {
            switch(e.Button)
            {
                case MouseButtons.Left:
                    ...
                    SelectedButtonLbl3.Text = "Of Touch Controller";
        ...
        private void TabletTouchBoardPnl_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void TabletTouchBoardPnl_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void TabletTouchBoardPnl_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                int i = 0;
                ...
                TabletTouchBoardPnl.Refresh();
            }

        }


        private void TabletTouchBoardPnl_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                int i = 0;
                ...
                if(mTrackPointList.Count >1)
                {
                    mSelectedMouseBtn = "Gesture" + mGestureResult;

                    SelectedButtonLbl1.Text = mSelectedMouseBtn;
                    SelectedButtonLbl2.Text = "On Touch Board";
                    SelectedButtonLbl3.Text = "Of Touch Controller";

                    if (!mMouseToJoystickTempMapping.ContainsKey(mSelectedMouseBtn))
                        mMouseToJoystickTempMapping[mSelectedMouseBtn] = new uint[2] { 0, 2 };
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping[mSelectedMouseBtn][0];
                    setActionRadio(mMouseToJoystickTempMapping[mSelectedMouseBtn][1]);
