...
namespace OnScreenVirtualJoystickController
{
    public partial class DirectionForm : Form
    {
        ...
        public DirectionForm(COMPONENTMODE mode)
        {
            InitializeComponent();
            this.Opacity = mOpacity;
            this.CircleBtn.BorderColor = mBackColor;
        ...
        private void adjustResizeController()
        {
            ...
            this.MovingPart.Width = Convert.ToInt32(CircleBtn.Width * (30.0 / 350.0));
            this.MovingPart.Left = (CircleBtn.Width / 2) - (MovingPart.Width / 2) + 10;

            mMinXAxis = -CircleBtn.Width / 2 + MovingPart.Width / 2;
            mMaxXAxis = CircleBtn.Width / 2 - MovingPart.Width / 2;
            mMinYAxis = -CircleBtn.Height / 2 + MovingPart.Height / 2;
            mMaxYAxis = CircleBtn.Height / 2 - MovingPart.Height / 2;
        }
            ...
            switch (mMode)
            {
                ...
                case COMPONENTMODE.RUN_MODE:
                    if (e.Button == MouseButtons.Left)
                    {
                        ...
                        mRwidth = CircleBtn.Width / 2 - MovingPart.Width / 2 - CircleBtn.BorderWidth / 8;
                        mRheight = CircleBtn.Height / 2 - MovingPart.Height / 2 - CircleBtn.BorderWidth / 8;

                        movingPartX = (int)((mRwidth) * Math.Cos(angleX) + CircleBtn.Width / 2 - MovingPart.Width / 2 + 10);
                        movingPartY = (int)((mRheight) * Math.Sin(angleY) + CircleBtn.Height / 2 - MovingPart.Height / 2 + 10);
