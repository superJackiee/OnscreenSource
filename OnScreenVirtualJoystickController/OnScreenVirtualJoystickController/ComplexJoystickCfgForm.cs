...
{
    public partial class ComplexJoystickCfgForm : Form
    {

        public ComplexControllerForm mController;
        ...
        public ComplexJoystickCfgForm(ComplexControllerForm controller)
        {
            InitializeComponent();
        ...
        public bool loadConfigFromFile()
        {
            if (!File.Exists("complex.list"))
            {
                ...
                mMouseToJoystickMapping.Add("Up_L_Id", new uint[2] { 21, 2 });
                mMouseToJoystickMapping.Add("Up_R_Id", new uint[2] { 22, 2 });
                mMouseToJoystickMapping.Add("Up_M_Id", new uint[2] { 23, 2 });
                mMouseToJoystickMapping.Add("Up_X1_Id", new uint[2] { 24, 2 });
                mMouseToJoystickMapping.Add("Up_X2_Id", new uint[2] { 25, 2 });

                mMouseToJoystickMapping.Add("Down_L_Id", new uint[2] { 26, 2 });
                mMouseToJoystickMapping.Add("Down_R_Id", new uint[2] { 27, 2 });
                mMouseToJoystickMapping.Add("Down_M_Id", new uint[2] { 28, 2 });
                mMouseToJoystickMapping.Add("Down_X1_Id", new uint[2] { 29, 2 });
                mMouseToJoystickMapping.Add("Down_X2_Id", new uint[2] { 30, 2 });

                mMouseToJoystickMapping.Add("Left_L_Id", new uint[2] { 31, 2 });
                mMouseToJoystickMapping.Add("Left_R_Id", new uint[2] { 32, 2 });
                mMouseToJoystickMapping.Add("Left_M_Id", new uint[2] { 33, 2 });
                mMouseToJoystickMapping.Add("Left_X1_Id", new uint[2] { 34, 2 });
                mMouseToJoystickMapping.Add("Left_X2_Id", new uint[2] { 35, 2 });

                mMouseToJoystickMapping.Add("Right_L_Id", new uint[2] { 36, 2 });
                mMouseToJoystickMapping.Add("Right_R_Id", new uint[2] { 37, 2 });
                mMouseToJoystickMapping.Add("Right_M_Id", new uint[2] { 38, 2 });
                mMouseToJoystickMapping.Add("Right_X1_Id", new uint[2] { 39, 2 });
                mMouseToJoystickMapping.Add("Right_X2_Id", new uint[2] { 40, 2 });

                mMouseToJoystickMapping.Add("Circle_L_Id", new uint[2] { 41, 2 });
                mMouseToJoystickMapping.Add("Circle_R_Id", new uint[2] { 42, 2 });
                mMouseToJoystickMapping.Add("Circle_M_Id", new uint[2] { 43, 2 });
            ...
            StreamReader _readfile = new StreamReader("complex.list");
        ...
        {
            StreamWriter _file = new StreamWriter("complex.list");
        ...
        private void UpButton_MouseClick(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
                    SelectedButtonLbl1.Text = "Mouse Left";
                    SelectedButtonLbl2.Text = "For Up Button";
                    mSelectedMouseBtn = "Up_L_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Up_L_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Up_L_Id"][1]);
                    break;
                case MouseButtons.Right:
                    SelectedButtonLbl1.Text = "Mouse Right";
                    SelectedButtonLbl2.Text = "For Up Button";
                    mSelectedMouseBtn = "Up_R_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Up_R_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Up_R_Id"][1]);
                    break;
                case MouseButtons.Middle:
                    SelectedButtonLbl1.Text = "Mouse Middle";
                    SelectedButtonLbl2.Text = "For Up Button";
                    mSelectedMouseBtn = "Up_M_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Up_M_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Up_M_Id"][1]);
                    break;
                case MouseButtons.XButton1:
                    SelectedButtonLbl1.Text = "Mouse XButton1";
                    SelectedButtonLbl2.Text = "For Up Button";
                    mSelectedMouseBtn = "Up_X1_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Up_X1_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Up_X1_Id"][1]);
                    break;
                case MouseButtons.XButton2:
                    SelectedButtonLbl1.Text = "Mouse XButton2";
                    SelectedButtonLbl2.Text = "For Up Button";
                    mSelectedMouseBtn = "Up_X2_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Up_X2_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Up_X2_Id"][1]);
                    break;
                    //default:
                    //    SelectedButtonLbl.Text = "";
            }
        ...
        private void DownButton_MouseClick(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
                    SelectedButtonLbl1.Text = "Mouse Left";
                    SelectedButtonLbl2.Text = "For Down Button";
                    mSelectedMouseBtn = "Down_L_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Down_L_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Down_L_Id"][1]);
                    break;
                case MouseButtons.Right:
                    SelectedButtonLbl1.Text = "Mouse Right";
                    SelectedButtonLbl2.Text = "For Down Button";
                    mSelectedMouseBtn = "Down_R_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Down_R_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Down_R_Id"][1]);
                    break;
                case MouseButtons.Middle:
                    SelectedButtonLbl1.Text = "Mouse Middle";
                    SelectedButtonLbl2.Text = "For Down Button";
                    mSelectedMouseBtn = "Down_M_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Down_M_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Down_M_Id"][1]);
                    break;
                case MouseButtons.XButton1:
                    SelectedButtonLbl1.Text = "Mouse XButton1";
                    SelectedButtonLbl2.Text = "For Down Button";
                    mSelectedMouseBtn = "Down_X1_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Down_X1_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Down_X1_Id"][1]);
                    break;
                case MouseButtons.XButton2:
                    SelectedButtonLbl1.Text = "Mouse XButton2";
                    SelectedButtonLbl2.Text = "For Down Button";
                    mSelectedMouseBtn = "Down_X2_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Down_X2_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Down_X2_Id"][1]);
                    break;
                    //default:
                    //    SelectedButtonLbl.Text = "";
            }
        ...
        private void LeftButton_MouseClick(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
                    SelectedButtonLbl1.Text = "Mouse Left";
                    SelectedButtonLbl2.Text = "For Left Button";
                    mSelectedMouseBtn = "Left_L_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Left_L_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Left_L_Id"][1]);
                    break;
                case MouseButtons.Right:
                    SelectedButtonLbl1.Text = "Mouse Right";
                    SelectedButtonLbl2.Text = "For Left Button";
                    mSelectedMouseBtn = "Left_R_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Left_R_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Left_R_Id"][1]);
                    break;
                case MouseButtons.Middle:
                    SelectedButtonLbl1.Text = "Mouse Middle";
                    SelectedButtonLbl2.Text = "For Left Button";
                    mSelectedMouseBtn = "Left_M_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Left_M_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Left_M_Id"][1]);
                    break;
                case MouseButtons.XButton1:
                    SelectedButtonLbl1.Text = "Mouse XButton1";
                    SelectedButtonLbl2.Text = "For Left Button";
                    mSelectedMouseBtn = "Left_X1_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Left_X1_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Left_X1_Id"][1]);
                    break;
                case MouseButtons.XButton2:
                    SelectedButtonLbl1.Text = "Mouse XButton2";
                    SelectedButtonLbl2.Text = "For Left Button";
                    mSelectedMouseBtn = "Left_X2_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Left_X2_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Left_X2_Id"][1]);
                    break;
                    //default:
                    //    SelectedButtonLbl.Text = "";
            }
        ...
        private void RightButton_MouseClick(object sender, MouseEventArgs e)
        {
            switch (e.Button)
            {
                case MouseButtons.Left:
                    SelectedButtonLbl1.Text = "Mouse Left";
                    SelectedButtonLbl2.Text = "For Right Button";
                    mSelectedMouseBtn = "Right_L_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Right_L_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Right_L_Id"][1]);
                    break;
                case MouseButtons.Right:
                    SelectedButtonLbl1.Text = "Mouse Right";
                    SelectedButtonLbl2.Text = "For Right Button";
                    mSelectedMouseBtn = "Right_R_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Right_R_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Right_R_Id"][1]);
                    break;
                case MouseButtons.Middle:
                    SelectedButtonLbl1.Text = "Mouse Middle";
                    SelectedButtonLbl2.Text = "For Right Button";
                    mSelectedMouseBtn = "Right_M_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Right_M_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Right_M_Id"][1]);
                    break;
                case MouseButtons.XButton1:
                    SelectedButtonLbl1.Text = "Mouse XButton1";
                    SelectedButtonLbl2.Text = "For Right Button";
                    mSelectedMouseBtn = "Right_X1_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Right_X1_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Right_X1_Id"][1]);
                    break;
                case MouseButtons.XButton2:
                    SelectedButtonLbl1.Text = "Mouse XButton2";
                    SelectedButtonLbl2.Text = "For Right Button";
                    mSelectedMouseBtn = "Right_X2_Id";
                    JoystickIDCmb.SelectedValue = mMouseToJoystickTempMapping["Right_X2_Id"][0];
                    setActionRadio(mMouseToJoystickTempMapping["Right_X2_Id"][1]);
                    break;
                    //default:
                    //    SelectedButtonLbl.Text = "";
            }
