...
{
    public partial class CompactJoystickCfgFrom : Form
    {
		public CompactControllerForm mController;
        ...
        public CompactJoystickCfgFrom(CompactControllerForm controller)
        {
            InitializeComponent();
		...
		public bool loadConfigFromFile()
        {
            ...
            StreamReader _readfile = new StreamReader("compact.list");					
        ...
        {
            StreamWriter _file = new StreamWriter("compact.list");
